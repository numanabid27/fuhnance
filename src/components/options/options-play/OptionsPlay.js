    ...
    <>
        <section className='bg-dark-color py-20'>
            <div className='container m-auto side-padding'>
                <div className='grid md:grid-cols-2 grid-col-1 gap-12 items-center'>
                    <div>
                        <img src='./images/options-stock.png' />
                    </div>
                    <div>
                        <h3 className='lg:text-xs text-md text-white font-semibold'>FREE Professional-Grade Analytics with Options Play</h3>
