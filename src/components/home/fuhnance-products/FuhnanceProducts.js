        ...
        <>
            <section className='relative sec md:py-20 py-14'>
                <div className='container m-auto side-padding'>
                    ...
                    <p className='text-white md:text-sm text-1x1 md:pt-0 pt-2 font-normal text-center '>Powerful platforms, tight spreads, fast execution, and dedicated support.</p>
